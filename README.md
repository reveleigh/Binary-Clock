...
Note: I've created an alternative script that strips back the functionality and uses toggle switches (buttons) to trigger a count-up sequence and a random number display. The file is called `button_operated_counter.py`.
